...
//
const BotName = 'FAST BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/achmad_ulin_nuha2?igshid=10m05y0l6b76'; // Nama Instagramlu cok
const whatsapplu = '0819-1238-7497'; // Nomor whatsapplu cok
...
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya ka..' ,MessageType.text);
}
else if (text == 'min'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
